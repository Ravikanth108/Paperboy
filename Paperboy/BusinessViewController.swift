...
class BusinessViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, IndicatorInfoProvider {
    ...
    func getNews(){
     let urlString = "https://newsapi.org/v2/top-headlines?country=ca&category=business&apiKey=7e2fa404249f4a03b625964089eaeefd"
