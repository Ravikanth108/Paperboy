...
class HealthViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, IndicatorInfoProvider {
    ...
    override func viewDidLoad() {
        ...
        func getNews(){
         let urlString = "https://newsapi.org/v2/top-headlines?country=ca&category=health&apiKey=7e2fa404249f4a03b625964089eaeefd"
